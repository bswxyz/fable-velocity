...
**Live demo → https://bswxyz.github.io/fable-velocity/** · [How it was built](https://bswxyz.github.io/fable-velocity/guide/)
...
```bash
gh repo create my-site --template bswxyz/fable-velocity --public --clone
cd my-site
